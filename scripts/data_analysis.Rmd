...
Peer_to_peer online lending platform has brought opportunities to investors, but at the same time, investors are also faced with the risk of user loan default, which is related to the sustainable and healthy development of the LendingClub platform.

### 1.3 Project Goal

The goal of this project is to help LendingClub to understand which borrowers are likely not to pay off their loan, and predict who is likely to pay off their loan in the future.
