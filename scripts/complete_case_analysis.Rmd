...
#### Packages used
```{r message=FALSE, echo=TRUE,cache=FALSE, results=TRUE, comment=FALSE, warning=FALSE}
library(tidyverse)
library(here)
library(janitor)
library(broom)
...
Therefore, for this kind of model, the ROC curve (AUC value) is a better measure of the model's performance. It gives us a real picture of the quality of our model by showing the true-positive rates against false-positive rates.
